...
# ==========================================================
# Batch MiniBUSCO / Compleasm (protein mode)
# ==========================================================
...
Required:
  -i, --input-dir DIR        Directory containing protein FASTA (*.aa)
...
Options:
  ...
  --suffix STR               Protein FASTA suffix (default: .aa)
  --no-keep-workdir          Remove per-sample output after summary
  -h, --help                 Show this help

Behavior:
  - Runs: compleasm protein
...
# -------------------------
cd "$WORKDIR"
echo -e "Sample\tBUSCO_Score\tS\tD\tF\tM" > BuscoScores_aa.tsv
...
done >> BuscoScores_aa.tsv

echo "✅ BUSCO summary written to: $WORKDIR/BuscoScores_aa.tsv"
